...
> Replaces 36 occurrences of `"nick"` and two compound forms
> (`"nick_bai"`, `"nick-bai"`) with the canonical placeholders.
...
| Before | After | Test |
|---|---|---|
| `"nick"` | `"alice"` | every `Username::parse(...)` / `username` JSON fixture |
| `"Nick123"` | `"Alice123"` | case-preservation test |
| `"nick@bad"` | `"alice@bad"` | parse-rejection (`@`) |
| `"nick:bad"` | `"alice:bad"` | parse-rejection (`:`) |
| `"nick bad"` | `"alice bad"` | parse-rejection (space) |
| `"nick.bad"` | `"alice.bad"` | parse-rejection (`.`) |
| `"nick_bai"` | `"alice_bob"` | underscore-allowed in username |
| `"nick-bai"` | `"alice-bob"` | hyphen-allowed in username |
| `nick:hunter2` (in URLs) | `alice:hunter2` | redaction tests against socks/https URLs |
...
`assert!(!out.contains("nick"), ...)` become
