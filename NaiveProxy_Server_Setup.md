...
:443, naive.coolwhite.space {
    tls your@email.com
    forward_proxy {
        basic_auth nick 19990515Wry
        hide_ip
        hide_via
        probe_resistance
    }
...
### Test HTTPS directly
```bash
curl -v https://naive.coolwhite.space
```
Expected: `OK`

### Test proxy directly from server
```bash
curl -v --proxy "https://nick:19990515Wry@naive.coolwhite.space:443" https://ipinfo.io
```
